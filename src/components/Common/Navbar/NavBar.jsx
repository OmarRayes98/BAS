    ...
    <>
          ...
          <ul className="aj-navbar-menu">
            {
              navElements.map((el, index) => {
                return <li key={index} className='aj-navbar-item'><a href="#" className={el.active? 'aj-navlink aj-navlink-active' : 'aj-navlink'}>{el.name}</a></li>
              })
            }
          </ul>
        </div>
      ...
      <div className={active}>
        ...
        <ul className="aj-sidebar-menu">
            {
              navElements.map((el, index) => {
                return <li key={index} className={el.active? 'aj-navbar-item aj-sideli-active' : 'aj-navbar-item'}><a href="#" className={el.active? 'aj-navlink aj-sidelink-active' : 'aj-navlink'}>{el.name}</a></li>
              })
            }
        </ul>
